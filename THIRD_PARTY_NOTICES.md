...
| `to-plan-onward` | [to-tickets](https://github.com/mattpocock/skills/blob/3cca18b368ae95cdbdebbff572ccafa662551015/skills/engineering/to-tickets/SKILL.md) | 保留纵向切片、依赖、任务粒度、用户确认、大范围重构例外及本地模板；输出限定为本地任务文件，增加计划更新和规范引用，使用项目约定；保留仅手动调用语义 |
